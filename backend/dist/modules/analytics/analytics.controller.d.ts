...
export declare class AnalyticsController {
    ...
    getStudentAnalytics(user: JwtPayload): Promise<{
        overview: {
    ...
    getClientAnalytics(user: JwtPayload): Promise<{
        overview: {
    ...
    getCollegeAnalytics(user: JwtPayload): Promise<{
        message: string;
    }>;
    getCollegeAnalyticsById(collegeId: string): Promise<{
        college: {
            id: string | undefined;
