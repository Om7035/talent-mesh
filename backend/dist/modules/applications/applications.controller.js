...
let ApplicationsController = class ApplicationsController {
    ...
    apply(projectId, user, dto) {
        return this.applicationsService.apply(user.sub, projectId, dto);
    }
    getProjectApplications(projectId, user) {
...
__decorate([
    (0, common_1.Post)('projects/:projectId/applications'),
    (0, roles_decorator_1.Roles)(client_1.Role.STUDENT),
    (0, common_1.HttpCode)(common_1.HttpStatus.CREATED),
    (0, swagger_1.ApiOperation)({ summary: 'Apply to a project [STUDENT]' }),
    openapi.ApiResponse({ status: common_1.HttpStatus.CREATED }),
    __param(0, (0, common_1.Param)('projectId', common_1.ParseUUIDPipe)),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object, application_dto_1.CreateApplicationDto]),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get all applications for a project [CLIENT]' }),
    ...
    __metadata("design:returntype", void 0)
], ApplicationsController.prototype, "getProjectApplications", null);
__decorate([
    (0, common_1.Patch)('applications/:id/status'),
    (0, roles_decorator_1.Roles)(client_1.Role.CLIENT),
    (0, swagger_1.ApiOperation)({ summary: 'Update application status [CLIENT]' }),
    openapi.ApiResponse({ status: 200 }),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object, application_dto_1.UpdateApplicationStatusDto]),
    __metadata("design:returntype", void 0)
], ApplicationsController.prototype, "updateStatus", null);
__decorate([
    (0, common_1.Patch)('applications/:id'),
    (0, roles_decorator_1.Roles)(client_1.Role.STUDENT),
    (0, swagger_1.ApiOperation)({ summary: 'Update application proposal [STUDENT]' }),
    openapi.ApiResponse({ status: 200 }),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __param(2, (0, common_1.Body)()),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(client_1.Role.STUDENT),
    (0, swagger_1.ApiOperation)({ summary: 'Get current student applications [STUDENT]' }),
    openapi.ApiResponse({ status: 200, type: [Object] }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Withdraw an application [STUDENT]' }),
