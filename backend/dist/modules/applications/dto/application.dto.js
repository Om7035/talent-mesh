...
class CreateApplicationDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { coverLetter: { required: false, type: () => String }, proposedBudget: { required: false, type: () => Number } };
    }
}
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['SHORTLISTED', 'REJECTED', 'ACCEPTED'] }),
    (0, class_validator_1.IsEnum)(['SHORTLISTED', 'REJECTED', 'ACCEPTED']),
    __metadata("design:type", String)
