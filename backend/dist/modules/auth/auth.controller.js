...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Account created successfully with JWT tokens.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Login successful with JWT tokens.' }),
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)('JWT'),
    (0, swagger_1.ApiOperation)({ summary: 'Get current authenticated user info from JWT payload' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns decoded JWT payload.' }),
